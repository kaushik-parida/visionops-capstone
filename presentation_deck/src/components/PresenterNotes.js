export const SLIDE_NOTES = {
  0: { say: "Welcome to our Capstone Technical Defense. As you saw, our teammate previously demonstrated the baseline PoC. Today, we are presenting Phase 2: Enterprise Architecture.", why: "Frames the presentation as a continuation and escalation of scope.", q: "What is the primary architectural driver for this Phase 2?" },
  1: { say: "The baseline PoC proved ML viability, but a basic script isn't a product. It lacked async data handling, blocked the UI thread, and couldn't translate raw bounding boxes into business rules.", why: "Establishes the architectural gap we solved.", q: "Why was the UI thread blocking such a critical issue?" },
  2: { say: "To scale to production, our objectives were four-fold: Edge Machine Learning, Automated Event Rules, High-Performance UI, and Ephemeral Storage.", why: "Shows structured project goals targeting the gaps.", q: "Why focus on Edge ML over Cloud?" },
